---
title: "Rêzedersên HTML'ê - Çavkaniya Kurdî"
---
...
export function First() {
    const params = {
        logo: "html.png",
        title: "Rêzedersên HTML'ê",
        description: "HTML, ji bo rûpelên Web'ê zimanê nîşandanîna standard e.\nBi HTML'ê hûn dikarin malpera xwe biafirînin.\nFêrbûna HTML hêsane û hûn ê jê bi kêf fêr bibin!",
